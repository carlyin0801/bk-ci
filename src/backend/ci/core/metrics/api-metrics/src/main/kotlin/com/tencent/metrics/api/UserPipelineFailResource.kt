...
import com.tencent.metrics.pojo.vo.PipelineFailAnalysisQueryReqVO
...
@Api(tags = ["USER_PIPELINE_FAIL"], description = "流水线-失败统计")
@Path("/user/pipeline/fail")
...
interface UserPipelineFailResource {
    ...
    fun queryPipelineFailSumInfo(
        ...
        userId: String,
        @ApiParam("查询条件", required = true)
        QueryCondition: PipelineFailAnalysisQueryReqVO
    ...
    fun queryPipelineFailDetailInfo(
        ...
        @QueryParam("pageSize")
        pageSize: Int
    ): Result<ListPageVO<PipelineFailDetailInfoDO>>
}