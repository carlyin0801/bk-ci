...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_INFO` (
  ...
  PRIMARY KEY (`PIPELINE_ID`),
  UNIQUE KEY `UNI_INX_TPI_PROJECT_NAME_CHANNEL` (`PROJECT_ID`,`CHANNEL`,`PIPELINE_NAME`),
...
CREATE TABLE IF NOT EXISTS `T_PIPELINE_SETTING` (
    ...
    PRIMARY KEY (`PIPELINE_ID`),
    UNIQUE KEY `UNI_INX_TPS_PROJECT_PIPELINE_NAME` (`PROJECT_ID`,`NAME`,`IS_TEMPLATE`,`PIPELINE_ID`)
